package com.khue.calorietracker.core.data.preferences

import android.content.SharedPreferences
import com.khue.calorietracker.core.domain.model.ActivityLevel
import com.khue.calorietracker.core.domain.model.Gender
import com.khue.calorietracker.core.domain.model.GoalType
import com.khue.calorietracker.core.domain.model.UserInfo
import com.khue.calorietracker.core.domain.preferences.Preferences
...
class DefaultPreferences(
    ...
    override fun saveHigh(high: Int) {
        sharedPref.edit()
            .putInt(Preferences.KEY_HIGH, high)
            .apply()
    }
    ...
    override fun loadUserInfo(): UserInfo {
        ...
        val high = sharedPref.getInt(Preferences.KEY_HIGH, -1)
